 ...
 * oauth_client.php
 *
 * @(#) $Id: oauth_client.php,v 1.167 2020/09/23 05:10:21 mlemos Exp $
 *
 */
...
<class>
	...
	<version>@(#) $Id: oauth_client.php,v 1.167 2020/09/23 05:10:21 mlemos Exp $</version>
...
*/
	...
	var $oauth_user_agent = 'PHP-OAuth-API (http://www.phpclasses.org/oauth-api $Revision: 1.167 $)';
	...
	Function CheckAccessToken(&$redirect_url)
	{
		...
		switch(intval($this->oauth_version))
		{
			...
			case 2:
				...
				if($this->debug)
					$this->OutputDebug('Checking the authentication state in URI '.(IsSet($_SERVER['REQUEST_URI']) ? $_SERVER['REQUEST_URI'] : '"'.$this->redirect_uri.'"'));
